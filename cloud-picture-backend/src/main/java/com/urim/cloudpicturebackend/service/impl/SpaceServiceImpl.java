...
import com.urim.cloudpicturebackend.manager.sharding.DynamicShardingManager;
...
import com.urim.cloudpicturebackend.mapper.SpaceMapper;
...
//    private DynamicShardingManager dynamicShardingManager;
    ...
    public long addSpace(SpaceAddRequest spaceAddRequest, User loginUser) {
        ...
        String lock = String.valueOf(userId).intern(); // 设置每个用户一把锁 如果每个方法一把锁会出现很极端的报错
        synchronized (lock) {
