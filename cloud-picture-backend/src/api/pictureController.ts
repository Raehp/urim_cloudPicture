...
export async function listPictureTagCategoryUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponsePictureTageCategory_>('/api/picture/tag_category', {
    method: 'GET',
    ...(options || {}),
  })
}
...
/** doPictureByBatch POST /api/picture/upload/batch */
export async function doPictureByBatchUsingPost(
