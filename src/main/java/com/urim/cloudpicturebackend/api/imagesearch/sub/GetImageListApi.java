...
public class GetImageListApi {
    ...
    public static void main(String[] args) {
        String url = "https://graph.baidu.com/ajax/pcsimi?carousel=503&entrance=GENERAL&extUiData%5BisLogoShow%5D=1&inspire=general_pc&limit=30&next=2&render_type=card&session_id=12197310281826900329&sign=1262fa0fc10dd518bb95e01761988287&tk=901f4&tpl_from=pc";
        List<ImageSearchResult> imageList = getImageList(url);
        System.out.println("搜索成功：" + imageList);
        // 定义百度图片搜索的URL链接
    }
        // 调用getImageList方法获取图片搜索结果列表
}
        // 输出搜索成功的提示信息及结果
